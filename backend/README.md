...
Backend de la plataforma RAG del TFM. FastAPI + SQLAlchemy 2.x async + Alembic
+ pydantic 2.
...
mypy src/                   # 104 source files limpios al cierre de sesión 6
```

`ruff.toml` y `mypy.ini` tienen la configuración. No editarlos sin avisar.
