...
async def test_credential(
    ...
    *,
    ...
    try:
        ...
        friendly = {
            401: "Clave inválida o no autorizada (HTTP 401)",
            403: "Acceso denegado (HTTP 403)",
            404: "Endpoint no encontrado (HTTP 404)",
        }.get(code, f"El proveedor respondió con HTTP {code}")
        return TestCredentialResult(ok=False, latency_ms=latency, error=friendly)
