...
class WidgetConfig:
    ...
    # Personalised variant used when the host page provides a visitor name.
    # `{name}` is substituted client-side; falls back to `welcome_message`
    # (anonymous) when no name is available.
    welcome_message_named: str = "Hola {name}, ¿en qué puedo ayudarte?"
    ...
    def __post_init__(self) -> None:
        ...
        _validate_str_len(
            "welcome_message_named", self.welcome_message_named, 1, _MAX_WELCOME
        )
    ...
    def from_dict(cls, data: dict[str, Any]) -> "WidgetConfig":
        ...
        return cls(
            ...
            welcome_message_named=data.get(
                "welcome_message_named", defaults.welcome_message_named
            ),
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "welcome_message_named": self.welcome_message_named,
